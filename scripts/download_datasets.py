...
def generate_sample_ed_boundaries():
    ...
    sample_eds = [
        {"ed_id": "01001", "name": "Carlow Urban", "county": "Carlow", "population": 20504,
         "coords": [[-6.9261, 52.8386], [-6.9361, 52.8386], [-6.9361, 52.8286], [-6.9261, 52.8286]]},
        {"ed_id": "01002", "name": "Carlow Rural", "county": "Carlow", "population": 3789,
         "coords": [[-6.9561, 52.8586], [-6.9661, 52.8586], [-6.9661, 52.8486], [-6.9561, 52.8486]]},
        {"ed_id": "02001", "name": "Cavan", "county": "Cavan", "population": 4356,
         "coords": [[-7.3603, 53.9907], [-7.3703, 53.9907], [-7.3703, 53.9807], [-7.3603, 53.9807]]},
        {"ed_id": "03001", "name": "Ennis No. 1 Urban", "county": "Clare", "population": 8742,
         "coords": [[-8.9861, 52.8430], [-8.9961, 52.8430], [-8.9961, 52.8330], [-8.9861, 52.8330]]},
        {"ed_id": "04001", "name": "Cork City North A", "county": "Cork City", "population": 3456,
         "coords": [[-8.4756, 51.9014], [-8.4856, 51.9014], [-8.4856, 51.8914], [-8.4756, 51.8914]]},
        {"ed_id": "04002", "name": "Cork City South A", "county": "Cork City", "population": 2987,
         "coords": [[-8.4656, 51.8914], [-8.4756, 51.8914], [-8.4756, 51.8814], [-8.4656, 51.8814]]},
        {"ed_id": "07001", "name": "Dublin City Artane A", "county": "Dublin City", "population": 3254,
         "coords": [[-6.1914, 53.3849], [-6.2014, 53.3849], [-6.2014, 53.3749], [-6.1914, 53.3749]]},
        {"ed_id": "07002", "name": "Dublin City Artane B", "county": "Dublin City", "population": 4123,
         "coords": [[-6.2014, 53.3849], [-6.2114, 53.3849], [-6.2114, 53.3749], [-6.2014, 53.3749]]},
        {"ed_id": "07003", "name": "Rathmines West A", "county": "Dublin City", "population": 2876,
         "coords": [[-6.2658, 53.3250], [-6.2758, 53.3250], [-6.2758, 53.3150], [-6.2658, 53.3150]]},
        {"ed_id": "07004", "name": "Rathmines West B", "county": "Dublin City", "population": 3012,
         "coords": [[-6.2758, 53.3250], [-6.2858, 53.3250], [-6.2858, 53.3150], [-6.2758, 53.3150]]},
        {"ed_id": "07005", "name": "Rathmines West C", "county": "Dublin City", "population": 1234,
         "coords": [[-6.2658, 53.3150], [-6.2758, 53.3150], [-6.2758, 53.3050], [-6.2658, 53.3050]]},
        {"ed_id": "10001", "name": "Galway City East", "county": "Galway City", "population": 5678,
         "coords": [[-9.0300, 53.2750], [-9.0400, 53.2750], [-9.0400, 53.2650], [-9.0300, 53.2650]]},
        {"ed_id": "13001", "name": "Killarney Urban", "county": "Kerry", "population": 6543,
         "coords": [[-9.5074, 52.0583], [-9.5174, 52.0583], [-9.5174, 52.0483], [-9.5074, 52.0483]]},
        {"ed_id": "15001", "name": "Portlaoise Urban", "county": "Laois", "population": 8123,
         "coords": [[-7.2994, 53.0341], [-7.3094, 53.0341], [-7.3094, 53.0241], [-7.2994, 53.0241]]},
        {"ed_id": "16001", "name": "Limerick City North A", "county": "Limerick City", "population": 3456,
